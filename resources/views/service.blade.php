                        ...
                        <div class="table-responsive-md">
                            <table class="table table-dark table-striped table-bordered table-hover">
                                ...
                                <tbody id="myTable">
                                    ...
                                    <tr>
                                        <td>
                                            <a href="#" style="margin-bottom:5px;" class="show-modal btn btn-info" data-id='{{$p->id}}' data-titre='{{$p->titre}}' data-contenu='{{$p->contenu}}' data-icon='{{$p->icon}}'
                                              data-couleur='{{$p->couleur}}'><i class="fa fa-eye"></i></a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" action="{!! route('Deleteservice') !!}" method="post">
                    ...
                    <p>Voulez vous vriament supprimer ce service ?<b id="delTitre"></b></p>
            </div>
            <div class="modal-footer">
